...
import vrepapiscala.common.VRepObject

/**
  * Created by troxid on 22.11.15.
  */

class VisionSensor private[vrepapiscala](val remote: remoteApi, val id: Int, val handle: Int, resolution: (Int, Int),
                                         val opMode: OpMode) extends VRepObject {
