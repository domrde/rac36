...
import vrepapiscala.common.{EulerAngles, VRepObject, Vec3}

/**
  * Created by troxid on 24.11.15.
  */
class PositionSensor private[vrepapiscala](val remote: remoteApi, val id: Int, val handle: Int, val opMode: OpMode)
  extends VRepObject {
